...
{
	echo "
	$('#cd_block$i .cd-read-more').click(function(){
		if(open[$i]==0)
		{
			$('#cd_block$i .show_on_more').slideDown();
			$('#cd_block$i .cd-read-more').text('show less');
			open[$i]=1;
		}
		else
		{
			$('#cd_block$i .show_on_more').slideUp();
			$('#cd_block$i .cd-read-more').text('show more');
			open[$i]=0;
		}
