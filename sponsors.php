...
<body class="flagstone-about-us">
	...
	<div class="row grid-container-fluid">
		<div class="left-section col-md-8 padl">
						...
						<div class="grid-row">
							<div class="push-column-2 col-xs-6 col-sm-4 margin-bottom-20 sponsordiv">
								<div class="overlay">
									...
									<img src="img/Sponsors/title/starsports.png" alt="starsports" class="overlay__image">
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 push-column-1 margin-bottom-20 sponsordiv">
								<div class="overlay">
									...
									<img src="img/Sponsors/title/bmw.png" alt="bmw" class="overlay__image">
								</div>
							</div>
						</div>
						<div class="grid-row">
							<div class="col-xs-6 col-sm-4 margin-bottom-20 sponsordiv">
								<div class="overlay">
									...
									<img src="img/Sponsors/title/continental.png" alt="continental" class="overlay__image">
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 margin-bottom-20 sponsordiv">
								<div class="overlay">
							...
							<div class="col-xs-6 col-sm-4 margin-bottom-20 sponsordiv">
								<div class="overlay">
									...
									<img src="img/Sponsors/title/liqui.png" alt="liqui" class="overlay__image">
								</div>
							</div>
						</div>
					</div>
			...
			<section class="gold-sponsors" id="goldsponsors">
				<div class="grid-container-fluid">
					<h4 class="text-left  heading-sponsor" title="click to expand">Gold Sponsors<span class="faspan"> <i class="fa fa-plus" aria-hidden="true">&nbsp;</i></span></h4>
							...
							<div class="grid-row">
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Parksyde Homes</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">SKF</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-right"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">TE Connectivity</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Hitachi</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-right"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Red Bull</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Henkel</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-right"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">ABC Composites</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Behr</span>
										</div>
								...
								<div class="col-xs-6 col-sm-3 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-right"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Atul</span>
										</div>
										<img src="img/Sponsors/gold/atul.png" alt="picture" class="overlay__image">
									</div>
								</div>
							</div>
						</div>
			...
			<section class="silver-sponsors" id="silversponsors">
				<div class="grid-container-fluid">
					<h4 class="text-left  heading-sponsor" title="click to expand">Silver Sponsors<span class="faspan"> <i class="fa fa-plus" aria-hidden="true">&nbsp;</i></span></h4>
					<div class="hide-n-seek">
						<div class="grid-container-fluid">
							<div class="grid-row">
								<div class="col-xs-4 col-sm-2 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Mitter Fastners</span>
										</div>
								...
								<div class="col-xs-4 col-sm-2 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Mentor Graphics</span>
										</div>
								...
								<div class="col-xs-4 col-sm-2 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-right"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">Ricardo</span>
										</div>
								...
								<div class="col-xs-4 col-sm-2 margin-bottom-20 sponsordiv">
									<div class="overlay">
										<div class="overlay__background overlay__background--slide-left"></div>
										<div class="overlay__content text-center text-color-2">
											<span class="overlay__content-heading">SBEE Cables</span>
										</div>
			...
			<section class="bronze-sponsors" id="bronzesponsors">
				<div class="grid-container-fluid">
					<h4 class="text-left  heading-sponsor" title="click to expand">Bronze Sponsors<span class="faspan"> <i class="fa fa-plus" aria-hidden="true">&nbsp;</i></span></h4>
					<div class="hide-n-seek">
						<div class="grid-container-fluid">
							<div class="grid-row">
								<div class="col-xs-4 col-sm-2 margin-bottom-20 sponsordiv">
	...
	<script type="text/javascript" src="js/min/myjs/sponsors.js"></script>
</body>
</html>