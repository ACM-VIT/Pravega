					...
					<ul class="nav float-right">
						...
						<li class="nav-item has-submenu">
							...
							<ul class="is-submenu">
								...
								<li><a href="events.php#cd_block2">FS Germany 2015</a></li>
								<li><a href="events.php#cd_block3">JK Tyre FDC 2015</a></li>
								<li><a href="events.php#cd_block4">FS Germany 2014</a></li>
								<li><a href="events.php#cd_block5">FS Italy 2013</a></li>
							</ul>
						</li>
						<li class="nav-item has-submenu">
							<a href="#">Media</a>
