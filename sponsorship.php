<?php
$title="Pravega Racing - Sponsorship";
...
<link rel="stylesheet" type="text/css" href="css/mycss/sponsorship.css" />
<style>
...
<body class="flagstone-about-us">
	...
	<section class="first-section title-sponsors">
		<div class="grid-container-fluid padlr">
			<h3 class="text-left heading-sponsor" title="click to expand">Title Sponsors<span class="faspan"> <i class="fa fa-plus" aria-hidden="true">&nbsp;</i></span></h3>
	...
	<section class="first-section gold-sponsors">
		<div class="grid-container-fluid padlr">
			<h3 class="text-left  heading-sponsor" title="click to expand">Gold Sponsors<span class="faspan"> <i class="fa fa-plus" aria-hidden="true">&nbsp;</i></span></h3>
			<div class="hide-n-seek">
				<div class="grid-container-fluid">
					<div class="grid-row">
						<div class="col-xs-6 col-sm-4 push-column-4 margin-bottom-20 sponsordiv">
							<div class="overlay">
								<div class="overlay__background overlay__background--slide-left"></div>
								<div class="overlay__content text-center text-color-2">
	...
	<section class="first-section silver-sponsors">
		<div class="grid-container-fluid padlr">
			<h3 class="text-left  heading-sponsor" title="click to expand">Silver Sponsors<span class="faspan"> <i class="fa fa-plus" aria-hidden="true">&nbsp;</i></span></h3>
			<div class="hide-n-seek">
				<div class="grid-container-fluid">
					<div class="grid-row">
						<div class="col-xs-6 col-sm-4 push-column-4 margin-bottom-20 sponsordiv">
	...
	?>
	<script type="text/javascript" src="js/min/myjs/sponsorship.js"></script>
</body>
</html>